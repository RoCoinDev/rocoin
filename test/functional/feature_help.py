...
"""Verify that starting rocoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rocoin with -h for help text")
        ...
        self.log.info("Start rocoin with -version for version information")
        ...
        self.log.info("Start rocoind with -fakearg to make sure it does not start")
