...
* Update manpages, see [gen-manpages.sh](https://github.com/rocoindev/rocoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/rocoindev/gitian.sigs.roc.git
    git clone https://github.com/rocoindev/rocoin-detached-sigs.git
...
- Detached signatures will then be committed to the [rocoin-detached-sigs](https://github.com/rocoindev/rocoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the rocoin.org server, nor put them in the torrent*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/rocoindev/rocoin/releases/new) with a link to the archived release notes.
