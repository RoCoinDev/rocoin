# Support for Output Descriptors in ROCoin Core

Since ROCoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `roc1...` for mainnet or `troc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on ROCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing ROCoin Core wallets, a convenience function `combo` is
