...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " rocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  rocoin-tx [options] <hex-tx> [commands]  Update hex-encoded rocoin transaction\n" +
            "or:     rocoin-tx [options] -create [commands]   Create hex-encoded rocoin transaction\n" +
            "\n";
