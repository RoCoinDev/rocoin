...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.rocoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.rocointools.com");
        vSeeds.emplace_back("dnsseed.rocoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.rocointools.com");
        vSeeds.emplace_back("seed-b.rocoin.loshan.co.uk");
