...
const char * const BITCOIN_CONF_FILENAME = "rocoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ROCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/ROCoin";
#else
    // Unix
    return pathRet / ".rocoin";
#endif
#endif
}
