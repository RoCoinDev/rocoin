...
bech32_templates = [
  ...
  ('roc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('roc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('roc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('troc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('troc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('troc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rroc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rroc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rroc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('troc',  17, 32, False, False, False),
  ('rroc',  3,  1, False, False, False),
  ('roc',   15, 41, False, False, False),
  ('troc',  0, 16, False, False, False),
  ('rroc',  0, 32, True,  False, False),
  ('roc',   0, 16, True,  False, False),
  ('troc',  0, 32, False, True,  False),
  ('rroc',  0, 20, False, False, True)
]
